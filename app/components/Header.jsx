...
const navigate = useNavigate()
  ...
  return (
    <>
      ...
      <nav className={`${className} ${isDrawerOpen ? 'open' : ''}`} role="navigation">
    ...
    <nav className="header-ctas" role="navigation">
      ...
      <div className="dropdown">
        ...
        <ul className="dropdown-menu" id="dropdownMenu">
          <li className="dropdown-item" data-value="de-de">
            <img src="https://cdn.shopify.com/s/files/1/0661/7595/9260/files/united-kingdom-flag-icon.svg?v=1721643633" />
          </li>
          <li className="dropdown-item" data-value="en-de">
            <img src="https://cdn.shopify.com/s/files/1/0661/7595/9260/files/Flag-of-Germany-01.svg?v=1721643447" />
          </li>
        </ul>
      </div>
